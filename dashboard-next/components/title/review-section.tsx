...
export function ReviewSection({ reviews, platform, platformColor }: ReviewSectionProps) {
        ...
        <>
          ...
          {visibleCount < sorted.length && (
            <button
              ...
              className="w-full py-2 mt-3 text-sm text-blue-500 hover:text-blue-600 hover:bg-muted/50 rounded-lg transition-colors cursor-pointer"
            >
